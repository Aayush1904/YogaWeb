...
const Login = () => {
    ...
    const {login , error , loader , setError , setLoader} = useAuth();
  ...
  return (
    <div className='mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8'>
      ...
      <p className='mx-auto mt-4 max-w-md text-center text-gray-600'>Explore our comprehensive library of courses and content , exclusively crafted for you all to expertise.</p>
        ...
        <form onSubmit={handleSubmit} className='space-y-4' >
            ...
            <div>
                ...
                <div className='relative'>
                    ...
                    <span onClick={() => setShowPassword(!showPassword)} className='absolute inset-y-0 end-0 grid place-content-center px-4 '><BsFillEyeFill className='h-4 w-4 text-gray-400 ' /></span>
                </div>
            </div>
