        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='flex items-center gap-5'>
                ...
                <div className='mb-4'>
                    ...
                    <input type="password" placeholder='Confirm your password' {...register("confirmPassword" , {required: true })} className='w-full border-gray-300 border rounded-md py-2 px-4 focus:outline-none focus:ring focus:border-blue-300' />
                </div>
            </div>
            <div className='flex items-center gap-5'>
                <div className='mb-4'>
            ...
            <div className='text-center'>
                <button type='submit' className='bg-secondary hover:bg-black text-white py-2 px-4 rounded-md'>Register</button>
                {
                    errors && (<div className='text-gray-500 text-sm w-full mt-1 '>
                        <p>Password doesnt match</p>
                    </div>)
                }
            </div>
        </form>
        <p className='text-center mt-4'>Already have an account <Link to= '/login' className='underline text-secondary ml-1' >Login</Link></p>
        <GoogleLogin />
      </div>
    </div>
  )
